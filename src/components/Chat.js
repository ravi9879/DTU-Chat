...
function App() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #e0eafc 0%, #a1c4fd 100%)",
        minHeight: "100vh",
      }}
    >
      <div
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 2px 8px rgba(41,72,255,0.08)",
          }}
        >
          <div className="d-flex align-items-center gap-2">
            <i className="bi bi-chat-dots-fill fs-3 me-2"></i>
            <span className="fw-bold fs-4" style={{ letterSpacing: 1 }}>SmartChat</span>
          </div>
          <button
            onClick={clearChats}
        ...
        {/* Chat messages */}
        <div className="card-body overflow-auto px-4 py-3" style={{ height: 400, background: "rgba(248,250,252,0.7)" }}>
          {messages.length === 0 && (
          ...
          {messages.map((msg, i) => (
            <div
              key={i}
              className={`d-flex mb-3 ${msg.sender === user_id ? "justify-content-end" : "justify-content-start"}`}
            >
              <div
                className={`p-3 rounded-4 shadow-sm position-relative ${msg.sender === user_id
              ...
              >
                <div className="fw-bold small mb-1" style={{ opacity: 0.85 }}>
                  {msg.sender === user_id ? "You" : <span><i className="bi bi-robot"></i> Bot</span>}
                </div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 -2px 8px rgba(41,72,255,0.04)",
          }}
        >
          <form
          ...
          >
            <input
              ...
              style={{
                background: "#f1f5f9",
                border: "none",
                boxShadow: "0 1px 4px rgba(41,72,255,0.07)",
                fontSize: 16,
              }}
              autoFocus
            />
